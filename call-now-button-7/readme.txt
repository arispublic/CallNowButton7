=== Plugin Name ===
Contributors: Aris Priyantoro
Site: http://aris.pituruh.com/
...
A very simple yet very effective plugin that adds a Call Now button to your website for mobile visitors (only for mobile optimized websites). This plugin is a fork from  http://callnowbutton.com/
...
1. From your WordPress Dashboard go to 'Plugins' > 'Add new' and search for 'Call Now Button 7'.
2. Click 'Install Now' under the title of the Call Now Button plugin
3. Click activate
4. Go to 'Settings' > 'Call Now Button 7' and check the box to activate the button and enter your phone number.
...
3. Go to 'Settings' > 'Call Now Button 7' and check the box to activate the button and enter your phone number.
...
= 0.0.1 =
* First time launch after forking

= 0.0.2 =
* Show multiple buttons in a page.
